...
# we make a line which represents Linear Model that would fit transform X to Y (pH to Alcohol)
ggplot(data = data, aes( x = pH, y = alcohol) ) + 
  geom_point() +
  theme_minimal() +
...
# we can also group plots together and visualize them at once
...
# now we are comparing categorical variable to continous
